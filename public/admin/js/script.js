...
// end Xử lý logic checkbox Multi
...
if (formChangeMulti) {
  formChangeMulti.addEventListener("submit", (e) => {
    ...
    if (inputsChecked.length > 0) {
      ...
      alert("Vui lòng click chọn");
    }
  });

}
// END Xử lý Form-change-Multi
